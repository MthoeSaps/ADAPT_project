...
with st.sidebar:
    image_path = 'bulawayo water bodies mapping project/images/logo7.png'
...
def water_body_analysis():
    ...
    folder_path = 'bulawayo water bodies mapping project/TIFF images'
...
def contribute_map():
    ...
    upload_folder = "bulawayo water bodies mapping project/map contributions"
